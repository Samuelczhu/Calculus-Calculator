...
public class Derivative {
    ...
    public void Calculate() {
        try {
            ...
            double x = eval(xInput.getText());
            double h = eval(hInput.getText());
            double answer = derivative(function, x, h);
    ...
    private double derivative(String function, double x, double h) {
        double f = eval(subin(function,x));
        double fh = eval(subin(function, x+h));
        return (fh-f)/h;
    }
